 ...
 * 클래스간으 상속이 가능하며, 이를 통해 확장성이 높다. 단, 메모리 효율성이 좋지 않다.
...
class Customer {
    ...
    // function
    order():void{
        console.log(`${this.name}이 ${this.menu.name}를 주문했다.`);
        
    };
}

// 인스턴스 생성
const hong:Customer = new Customer("홍길동",30, new Menu('아아',100),1000);
console.log(hong);
hong.order();